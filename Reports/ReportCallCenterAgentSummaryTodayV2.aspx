<%@ Page Title="" Language="C#" MasterPageFile="~/ACMG.Master" AutoEventWireup="true" CodeBehind="ReportCallCenterAgentSummaryTodayV2.aspx.cs" Inherits="ACMGAdmin.Reports.ReportCallCenterAgentSummaryTodayV2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Label ID="LabelReportTitle" runat="server" Font-Bold="True" 
            Font-Size="X-Large" Text="Call Center Agent Summary Report Today Version 2" 
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <localreport reportpath="Reports\Report_CallCenterAgentSummaryTodayV2.rdlc">
                <datasources>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="sp_Report_AgentSummary_RT" 
