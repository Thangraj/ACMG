<%@ Page Title="" Language="C#" MasterPageFile="~/ACMG.Master" AutoEventWireup="true" CodeBehind="Report_CallCenterAgentSummaryTodayV2.aspx.cs" Inherits="ACMGAdmin.Reports.Report_CallCenterAgentSummaryTodayV2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Label ID="LabelReportTitle" runat="server" Font-Bold="True" 
            Font-Size="X-Large" Text="Agent Summary Report Today" 
